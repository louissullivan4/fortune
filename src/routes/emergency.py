...
async def pause_trading(request: Request):
    ...
    try:
        ...
        logger.warning(
            "Emergency pause endpoint called - use /live-trading/pause instead"
        )
        return {
            "message": "Emergency pause endpoint deprecated. Use /live-trading/pause instead."
        }
...
async def resume_trading(request: Request):
    ...
    try:
        ...
        logger.warning(
            "Emergency resume endpoint called - use /live-trading/resume instead"
        )
        return {
            "message": "Emergency resume endpoint deprecated. Use /live-trading/resume instead."
        }
    except Exception as e:
...
async def dump_positions(request: Request):
    ...
    try:
        ...
        logger.warning(
            "Emergency dump positions endpoint called - use live trading service instead"
        )
        return {
            "message": "Emergency dump positions endpoint deprecated. Use live trading service for position management."
        }
    except Exception as e:
...
async def get_trading_status(request: Request):
    ...
    try:
        ...
        logger.warning(
            "Emergency status endpoint called - use /live-trading/status instead"
        )
        return {
            "message": "Emergency status endpoint deprecated. Use /live-trading/status instead."
        }
    except Exception as e:
