...
const Button = ({
  ...
  const variantClasses = {
    primary:
      "bg-primary-teal text-white hover:bg-primary-teal-hover focus:ring-primary-teal shadow-sm",
    secondary:
      "bg-white text-primary-teal border border-primary-teal hover:bg-gray-50 focus:ring-primary-teal",
    danger:
      "bg-danger-red text-white hover:bg-red-700 focus:ring-danger-red shadow-sm",
    ghost:
      "bg-transparent text-primary-teal hover:bg-primary-accent-light focus:ring-primary-teal",
    success:
      "bg-success-green text-white hover:bg-green-700 focus:ring-success-green shadow-sm",
    warning:
      "bg-warning-orange text-white hover:bg-orange-700 focus:ring-warning-orange shadow-sm",
  };
  ...
  const renderIcon = () => {
    ...
    return (
      <IconComponent size={iconSize} className={iconClass} aria-hidden="true" />
    );
  };
